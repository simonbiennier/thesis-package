 ...
 * @author Guy Allard
 */
public class AA_0009_RF extends TestCase {
  ...
  public static TestSuite suite() {
    return new TestSuite(AA_0009_RF.class);
  }

  public AA_0009_RF(String name) {
    super(name);
  }
  ...
  public void testBasicComps1() {
    ...
    cSecond = DateTimeComparator.getInstance(DateTimeFieldType.secondOfMinute(),
        DateTimeFieldType.minuteOfHour());
    cMinute = DateTimeComparator.getInstance(DateTimeFieldType.minuteOfHour(),
        DateTimeFieldType.hourOfDay());
    cHour = DateTimeComparator.getInstance(DateTimeFieldType.hourOfDay(),
        DateTimeFieldType.dayOfYear());
    cDayOfWeek = DateTimeComparator.getInstance(DateTimeFieldType.dayOfWeek(),
        DateTimeFieldType.weekOfWeekyear());
    cDayOfMonth = DateTimeComparator.getInstance(DateTimeFieldType.dayOfMonth(),
        DateTimeFieldType.monthOfYear());
    cDayOfYear = DateTimeComparator.getInstance(DateTimeFieldType.dayOfYear(),
  ...
  public void testListWOW() {
    cWeekOfWeekyear = DateTimeComparator.getInstance(DateTimeFieldType.weekOfWeekyear());
    String[] dtStrs = {
        "2002-04-01T10:00:00",
        "2002-01-01T10:00:00",
        "2002-12-01T10:00:00",
  ...
  public void testListMonth() {
    cMonth = DateTimeComparator.getInstance(DateTimeFieldType.monthOfYear());
    String[] dtStrs = {
        "2002-04-01T10:00:00",
        "2002-01-01T10:00:00",
        "2002-12-01T10:00:00",
