...
public class AA_0020_RF extends TestCase {
  ...
  public static TestSuite suite() {
    return new TestSuite(AA_0020_RF.class);
  }

  public AA_0020_RF(String name) {
    super(name);
  }
  ...
  public void testKeyYears_2126() {
    DateTime bd = new DateTime(2126, 1, 1, 0, 0, 0, 0, BUDDHIST_UTC);
    DateTime jd = new DateTime(1583, 1, 1, 0, 0, 0, 0, GJ_UTC);
    assertEquals(jd, bd.withChronology(GJ_UTC));
  ...
  public void testKeyYears_2125() {
    DateTime bd = new DateTime(2125, 1, 1, 0, 0, 0, 0, BUDDHIST_UTC);
    DateTime jd = new DateTime(1582, 1, 1, 0, 0, 0, 0, GJ_UTC);
    assertEquals(jd, bd.withChronology(GJ_UTC));
  ...
  public void testKeyYears_544() {
    DateTime bd = new DateTime(544, 1, 1, 0, 0, 0, 0, BUDDHIST_UTC);
    DateTime jd = new DateTime(1, 1, 1, 0, 0, 0, 0, GJ_UTC);
    assertEquals(jd, bd.withChronology(GJ_UTC));
  ...
  public void testKeyYears_543() {
    DateTime bd = new DateTime(543, 1, 1, 0, 0, 0, 0, BUDDHIST_UTC);
    DateTime jd = new DateTime(-1, 1, 1, 0, 0, 0, 0, GJ_UTC);
    assertEquals(jd, bd.withChronology(GJ_UTC));
  ...
  public void testKeyYears_1() {
    DateTime bd = new DateTime(1, 1, 1, 0, 0, 0, 0, BUDDHIST_UTC);
    DateTime jd = new DateTime(-543, 1, 1, 0, 0, 0, 0, GJ_UTC);
    assertEquals(jd, bd.withChronology(GJ_UTC));
