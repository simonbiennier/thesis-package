...
public class AA_0032_RF {
  ...
  public void testTopLevelListOfIntegerCollectionsDeserialization() {
    ...
    assertThat(toIntArray(target.get(0))).isEqualTo(expected[0]);
    assertThat(toIntArray(target.get(1))).isEqualTo(expected[1]);
    assertThat(toIntArray(target.get(2))).isEqualTo(expected[2]);
  }
